...
class validar(Resource):
    """
    Starts scan here/Aqui incia-se o scan.

    1 STEP/ETAPA - Authentication of the secret key/Autenticação da chave de segurança.
    2 STEP/ETAPA - Gets the parameters of scan/Pega os parametros da analise.
    3 STEP/ETAPA - Call the "create" file to generate the results/Chama o arquivo "create" para gerar os resultados.
    4 STEP/ETAPA - If API configuration is activate will return the json with results/Caso a configuracao de API esteja
    configurada o servidor ira retornar o json com os resultados da pesquisa.
    """
    def get(self, key, parametros):
        ...
        if sessao or sessao_api:
            ...
            data_usuario = self.db_data_user()
            os_system = 'windows'
