"""
It is the documentation of IntelligenceX API, but with some alterations/Essa é a documentação da API da IntelligenceX, mas com
algumas alterações.

Original documentation: https://github.com/IntelligenceX/SDK
"""
...
def logando_intelxapi(tipo, mensagem):
    """
